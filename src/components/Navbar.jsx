...
const Navbar = () => {
    ...
    return (
        <nav className="flex justify-between items-center py-4 sticky top-0 px-4 bg-[#1b1a1a] z-10">
            ...
            <div className={`${isMenuOpen ? "flex" : "hidden"} transition-all duration-200 max-lg:bg-[#2a2a2a] absolute max-lg:py-4 lg:static top-[70px] max-lg:text-white right-0 transform lg:flex flex-col lg:flex-row lg:translate-x-0 flex-grow justify-between items-center`}>
                <ul className="flex gap-4 lg:gap-14 bg-[#2a2a2a] lg:border border-gray-700 py-4 px-10 flex-col lg:flex-row rounded-none lg:rounded-full">
                    <Link
